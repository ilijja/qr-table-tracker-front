...
const Sidebar = ({children}) => {
  ...
  const navigation = [
    { name: "Home", to: "/home", initial: "H" },
    { name: "Products", to: "/products", initial: "P" },
    { name: "Maps", to: "/maps", initial: "M" },
  ];

  const teams = [
    { id: 1, name: "Heroiconss", href: "#", initial: "H", current: false },
  ...
  return (
    <>
      <div>
        ...
        <main className="py-10 lg:pl-72 min-h-screen bg-gray-200">
            {children}
        </main>
      </div>
    </>
